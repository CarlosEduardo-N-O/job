...
function AnexosPublicacao({
    publicacao,
}) {

    const anexos = Array.isArray(
        publicacao?.anexos
    )
        ? publicacao.anexos
        : [];
